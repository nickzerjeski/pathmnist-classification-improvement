...
\begin{frame}{Prediction Confidences}
  ...
  \vspace{0.1em}
  \includegraphics[width=0.94\textwidth]{figures/baseline224_stroma_nonstroma_confidence_comparison_threshold}
  % \begin{itemize}
...
\begin{frame}{Cancer Expert System}
  \centering
  \resizebox{0.96\textwidth}{!}{\input{figures/cancer_expert_tikz}}
\end{frame}
